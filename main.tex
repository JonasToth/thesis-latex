...
\[
    \beta = \arccos \frac{2 \rho_{i,j} \rho_{i,j} - 2 \rho_{i,j} \rho{i-1,j-1} \cos d\phi}{2 \rho_{i,j} \sqrt{\rho_{i,j} \rho_{i,j} + \rho{i-1,j-1} \rho{i-1,j-1} - 2 \rho_{i,j} \rho{i-1,j-1} \cos d\phi}}
\]
