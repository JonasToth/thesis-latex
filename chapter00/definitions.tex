...
\newglossaryentry{feature}{%
    name={Feature},
    text={feature},
    description={Feature are special points or elements of an image that can be recognized and distinguished from their surroundings. Corners and edges are simple features}}
