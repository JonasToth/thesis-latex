...
\newacronym{rgb}{RGB}{Color space defined by Red-Green-Blue values}
\newacronym{rgbd}{RGB-D}{Extending RGB by a depth value}
\newacronym{fps}{fps}{frames per second}
\newacronym{GPGPU}{GP-GPU}{General Purposes GPU}
