...
The local shape of an objects that is sampled by a depth sensor is characterized by its surface normal.
...
Approximating the normal for a measured surface point $P_{i,j}$ is possible using the cross product of its neighbours connecting vectors.
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{The characteristical look of a \Gls{flexion-image}.}\label{fig:flexion_images}
\end{figure}
...
\end{figure}
The decreases origin is the nature of the cross product.
\begin{equation*}
