...
set label default_name at graph 0.02,lehrpfad_default-0.018 left font ",11" noenhanced front textcolor ls 4
set label default_name at graph 0.02,office_default-0.018 left font ",11" noenhanced front textcolor ls 2
set label default_name at graph 0.02,synthetic_default-0.018 left font ",11" noenhanced front textcolor ls 5
