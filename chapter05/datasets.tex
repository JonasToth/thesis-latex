...
The in-house implementation, based on Singh's\cite{singh_report2015} work, of the visual odometry is very basic with the four following steps applied only on consecutive image.
